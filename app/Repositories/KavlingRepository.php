    ...
    private function addDivisiSelect(BaseBuilder $builder, $id_divisi)
    {
        $divisiFields = [
            ...
            5 => "pbb_pecah_nop, pbb_pecah_luas_bumi, pbb_pecah_njop_bumi, pbb_pecah_luas_bangunan,
                  ...
                  sertifikat_split_no_hgb, sertifikat_split_tanggal_terbit, sertifikat_split_tanggal_berakhir,
                  ...
                  sertifikat_balik_nama_ke, pbg_no, pbg_tanggal_terbit, pbg_tanggal_pengajuan, pbg_tipe,
                  pbg_status, pbg_dikirim_ke, pbg_tanggal_kirim, bphtb_tanggal_verifikasi,
