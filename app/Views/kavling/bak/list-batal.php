...
<script>
  ...
  $(function() {
    var table = $('#data_table').DataTable({
      ...
      // "responsive": true,
      ajax: {
        url: base_url + '/mkdt/getListBatal',
        type: "POST",
        dataType: "json",
        data: {
          [csrfName]: csrfHash
    ...
    $("#btn_export").on('click', function(e) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $("body").append($a);
          $a.attr("download", $("#id_proyek").select2('data')[0].text + "- List Konsumen Batal  Per " + d + ".xls");
          $a[0].click();
          $a.remove();
  ...
  $('#data_table th:nth-child(1)').css({
    'min-width': '50px',
    'max-width': '50px'
  });
  $('#data_table th:nth-child(3)').css({
    'min-width': '110px',
    'max-width': '110px'
  });
  $('#data_table th:nth-child(2), #data_table th:nth-child(4), #data_table th:nth-child(8)').css({
    'min-width': '250px',
    'max-width': '250px'
  });
</script>