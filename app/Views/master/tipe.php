            ...
            <div class="tab-content">
              <div class="tab-pane active" id="data-tipe" aria-labelledby="data-tipe-tab" role="tabpanel">
                ...
                <div class="form-group">
                  ...
                  <!-- <input type="text" id="siteplan" name="siteplan" class="form-control" placeholder="Siteplan" maxlength="255"> -->
                  <button id="download_gambar_kerja" type="button" class="btn btn-outline-primary btn-block waves-effect">Lihat Gambar Kerja</button>
                </div>
...
<script>
  ...
  function edit(id_tipe) {
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#download_gambar_kerja").attr("onclick", "download(" + response.id_gambar_kerja + ")")
  ...
  function download(e) {
    ...
    // var req = new X  MLHttpRequest();
    // var param = {
    //   "id_gambar_kerja": e
    // }; 

    // req.open("GET", '<?php echo base_url('produksi/get_gambarkerja') ?>/' + e, true);
    ...
    //   link.download = "Gambar_Kerja_" + new Date() + ".pdf";
    //   link.click();
    // };
    ...
    // $.ajax({
    //   url: '<?php echo base_url('produksi/get_gambarkerja') ?>',
    //   type: 'post',
    //   headers: {
    ...
    //   },
    //   beforeSend: function() {
    //     $('#download_gambar_kerja').html('Mengunduh <i class="fa fa-spinner fa-spin"></i>');
    //     $('#download_gambar_kerja').attr('disabled', true);
    //   },
    //   success: function(r) {
    //     if(r.status == false){
    ...
    //     $('#download_gambar_kerja').html('Unduh Gambar Kerja');
    //     $('#download_gambar_kerja').attr('disabled', false);
    //   }
    // });
  }
