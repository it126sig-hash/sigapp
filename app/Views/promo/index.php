        ...
        <div class="card">
          <div class="card-header border-bottom">
            <div class="col-md-4 mb-1">
              <label>Proyek <?=date("Y-m-d h:i:s")?></label>
      ...
      <div class="modal-dialog sidebar-sm">
        <form id="add-form" class="add-new-record modal-content pt-0">
          ...
          <div class="modal-header mb-1">
            <h5 class="modal-title" id="exampleModalLabel">Data Promo</h5>
          </div>
          <div class="modal-body flex-grow-1">
            ...
            <div class="form-group">
              <label for="namaCluster"> Nama Promo: </label>
              <input type="text" id="nama_promo" name="nama_promo" class="form-control" placeholder="Nama Promo" maxlength="255">
            </div>
            <div class="form-group">
              <label for="diskon"> Diskon : </label>
              <input type="text" id="diskon" name="diskon" class="form-control num" placeholder="Diskon" maxlength="255">
            </div>
            <div class="form-group">
              <label for="insentif"> Insentif: </label>
              <input type="text" id="insentif" name="insentif" class="form-control" placeholder="Insentif" maxlength="255">
            </div>
            <div class="form-group">
              <label for="tgl_berlaku_start">Tanggal Berlaku </label>
              <input type="text" id="tgl_berlaku_start" name="tgl_berlaku_start" class="form-control flatpickr-human-friendly" placeholder="Mulai" />
              <input type="text" id="tgl_berlaku_end" name="tgl_berlaku_end" class="form-control flatpickr-human-friendly" placeholder="Akhir" />
            </div>
            <div class="form-group">
              <label for="tgl_booking_start">Untuk Booking Tanggal </label>
              <input type="text" id="tgl_booking_start" name="tgl_booking_start" class="form-control flatpickr-human-friendly" placeholder="Mulai" />
              <input type="text" id="tgl_booking_end" name="tgl_booking_end" class="form-control flatpickr-human-friendly" placeholder="Akhir" />
            </div>
            <div class="form-group">
              <label for="keterangan">Keterangan</label>
              <textarea id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan Promo" rows="3"></textarea>
            </div>
            <div class="form-group">
...
<script>
  ...
  function edit(id_cluster) {
    $.ajax({
      ...
      success: function(r) {
        ...
        $("#id").val(r.id);
        $("#isActive").val(r.status);
        $("#nama_promo").val(r.nama_promo);
        $("#insentif").val(r.insentif);
        $("#keterangan").val(r.keterangan);
        $("#diskon").val(r.diskon).keyup();

        if (r.tgl_berlaku_start != "0000-00-00")
          document.querySelector("#tgl_berlaku_start")._flatpickr.setDate(r.tgl_berlaku_start);
        if (r.tgl_berlaku_end != "0000-00-00")
          document.querySelector("#tgl_berlaku_end")._flatpickr.setDate(r.tgl_berlaku_end);
        if (r.tgl_booking_start != "0000-00-00")
          document.querySelector("#tgl_booking_start")._flatpickr.setDate(r.tgl_booking_start);
        if (r.tgl_booking_end != "0000-00-00")
          document.querySelector("#tgl_booking_end")._flatpickr.setDate(r.tgl_booking_end);
  ...
  function remove(id_cluster) {
    Swal.fire({
      ...
      text: "Promo tidak akan terhapus, hanya jadi non-aktif",
      icon: 'warning',
