                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="card card-congratulation-medal">
                        <div class="card-body">
                            ...
                            <p class="card-text font-small-3"><select id="id_proyek" name="id_proyek" class="select2 form-control"></select></p>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown chart-dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a id="filter-6bulan" class="dropdown-item" href="javascript:void(0);">Per 6 Bulan Terakhir</a>
                                        <a id="filter-1tahun" class="dropdown-item" href="javascript:void(0);">Per 1 Tahun Terakhir</a>
                                    </div>
                                </div>
                            </div>
                        </div>
