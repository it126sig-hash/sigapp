			...
			<div class="col-12">
				<div class="card">
					<div class="card-header border-bottom">
						...
						<div class="col-md-4 mb-1">
							<button type="button" id="btn_draw" class="btn btn-outline-primary waves-effect ">Filter Data</button>
						</div>
						...
						<div class="col-md-6 mb-1">
							<button type="button" class="float-right btn btn-primary data-submit  btn-sm mr-1 col-sm-12 col-md-3 col-lg-3" onclick="add()" title="Add"> <i class="fa fa-plus"></i> Tambah Data</button>
						</div>
					</div>
					<div class="col-12">
					...
					<div class="modal-body flex-grow-1">
						...
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="file" class="custom-file-input" accept="application/pdf" name="id_filehj" id="id_filehj" />
								<label class="custom-file-label" id="label-id_filehj" for="label-id_filehj">Upload Pricelist</label>
						...
						<div class="row">
							<div class="col-md-6">
							<div class="form-group">
							<label for="tgl_harga">Tanggal</label>
							<input required type="text" id="tgl_harga" name="tgl_harga" class="form-control flatpickr-human-friendly" placeholder="Tanggal" />
						</div>


						<div class="form-group">
							<label for="namaCluster"> Row </label>
							<input required type="text" id="row" name="row" class="form-control" placeholder="Row" maxlength="255">
						</div>
						<div class="form-group">
							<label for="diskon"> Tipe </label>
							<select required id="id_tipe" name="id_tipe" class="custom-select select2">
							</select>
						</div>

						<div class="form-group">
							<label for="insentif">LB</label>
							<input required type="text" id="lb" name="lb" class="form-control" placeholder="LB" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">LT</label>
							<input required type="text" id="lt" name="lt" class="form-control" placeholder="LT" maxlength="255">
						</div>
							<div class="form-group">
							<label for="is_subsidi"> Subsidi </label>
							<select required id="is_subsidi" name="is_subsidi" class="custom-select form-control">
						...
						<div class="form-group">
							...
							<input required type="text" id="hargajual" name="hargajual" class="form-control num" placeholder="Harga Jual" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">Harga Jual Net</label>
							<input required type="text" id="hargajual_net" name="hargajual_net" class="form-control num" placeholder="Harga Jual Net" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">KPR</label>
							<input required type="text" id="kpr" name="kpr" class="form-control num" placeholder="KPR" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">Uang Muka</label>
							<input required type="text" id="uang_muka" name="uang_muka" class="form-control num" placeholder="Uang Muka" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">Biaya Admin</label>
							<input required type="text" id="biaya_adm" name="biaya_adm" class="form-control num" placeholder="Biaya Administrasi" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">BPHTB</label>
							<input required type="text" id="bphtb" name="bphtb" class="form-control num" placeholder="BPHTB" maxlength="255">
						</div>
						<div class="form-group">
							<label for="insentif">PPn</label>
							<input required type="text" id="ppn" name="ppn" class="form-control num" placeholder="ppn" maxlength="255">
						</div>

						<div class="form-group">
							<label for="insentif">Biaya Proses</label>
							<input required type="text" id="biaya_proses" name="biaya_proses" class="form-control num" placeholder="Biaya Proses" maxlength="255">
						</div>
						<div class="form-group hidden">
							<label for="insentif">Total</label>
							<input required type="text" id="total" name="total" readonly class="form-control num" placeholder="Total" maxlength="255">
						</div>
							</div>
						</div>
