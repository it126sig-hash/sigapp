      ...
      <div class="modal-dialog sidebar-sm">
        <form id="add-form" class="add-new-record modal-content pt-0">
          ...
          <div class="modal-body flex-grow-1">
            <div class="row">
              <input type="hidden" id="idSubitem" name="idSubitem" class="form-control" placeholder="Id subitem" maxlength="11" required>
            </div>

            <div class="form-group">
              <label for="idItem"> Ruangan: </label>
              <select id="idItem" name="idItem" class="custom-select select2 form-control" required>
                <!-- <option> Pilih Ruangan </option> -->
                <?php
                foreach ($item as $p) {
                  if ($p['is_active'] == 1)
                    echo "<option value='" . $p['id_item'] . "'>" . $p['nama_item'] . "</option>";
                  else
                    echo "<option disabled value='" . $p['id_item'] . "'>" . $p['nama_item'] . " (Tidak Aktif)</option>";
                }
                ?>
              </select>
            </div>
            <div class="form-group">
              <label for="namaSubitem"> Nama subitem: <span class="text-danger">*</span> </label>
              <input type="text" id="namaSubitem" name="namaSubitem" class="form-control" placeholder="Nama subitem" maxlength="500" required>
            </div>
        ...
        <form id="edit-form" class="add-new-record modal-content pt-0">
          ...
          <div class="modal-body flex-grow-1">
            ...
            <div>
              <div class="form-group">
                <label for="idItem"> Ruangan: </label>
                <select id="idItem" name="idItem" class="custom-select form-control" required>
                  <!-- <option> Pilih Ruangan </option> -->
                  <?php
                  foreach ($item as $p) {
                    if ($p['is_active'] == 1)
...
<script>
  ...
  function edit(id_subitem) {
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#edit-form #idSubitem").val(response.id_subitem);
        $("#edit-form #idItem").val(response.id_item);
        $("#edit-form #idGroup").val(response.id_group);
        $("#edit-form #namaSubitem").val(response.nama_subitem);
  ...
  function remove(id_subitem, stat) {
