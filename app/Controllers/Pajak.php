	...
	public function save()
	{
		...
		try {
			...
			if ($pph42_nilai > 0) {
				...
				$this->notif->tambah_notif("3;5", $notif, $actorId, $id_kavling, 0, \App\Enums\NotificationEvent::PAJAK_PPH, null, "siteplan/view?id_kavling=" . $id_kavling . "&tab=legal"); //keuangan legal
			}

			if ($ppn_tgl_bayar) {
				$notif = $isNew ? 'Melakukan pembayaran PPN' : 'Melakukan perubahan pembayaran/detail pada PPN';
				$this->notif->tambah_notif("3;5", $notif, $actorId, $id_kavling, 0, \App\Enums\NotificationEvent::PAJAK_PPN, null, "siteplan/view?id_kavling=" . $id_kavling . "&tab=legal"); //keuangan legal
			}
