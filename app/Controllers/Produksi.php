...
class Produksi extends BaseController
{
    ...
    function save()
    {
        ...
        $f['tanggal_pembangunan'] = $this->request->getVar('tanggal_pembangunan') ? $this->request->getVar('tanggal_pembangunan') : null;
        $f['tanggal_rencana_selesai_pembangunan'] = $this->request->getVar('tanggal_rencana_selesai_pembangunan') ? $this->request->getVar('tanggal_rencana_selesai_pembangunan') : null;
        ...
        if ($f['id_produksi'] == null) {
            ...
            if ($this->produksiModel->insert($f)) {
                $this->kavlingModel->update($id_kavling, ['id_produksi' => $this->produksiModel->getInsertID()]);
