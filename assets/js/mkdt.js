  ...
  $.ajax({
    ...
    success: function (x) {
      ...
      if (r) {
        ...
        if (r.ktp_lok != null) {
          src = r.ktp_lok;
          $("#file_ktp-here").html(`<img src = "${base_url + src}" width="100%" height="150px"/>`);
        }
        ...
        if (r.npwp_lok != null) {
          src = r.npwp_lok;
          $("#file_npwp-here").html(`<img src = "${base_url + src}" width="90%" height="150px"/>`);
        }
        ...
        if (r.data_diri_lok != null) {
          src = r.data_diri_lok;
          $("#file_data_diri-here").html('Klik untuk melihat file');
        }
  ...
  ajax: {
    ...
    processResults: function (r) {
      ...
      $.each(r.data, function (k, v) {
        results.push({
          id: v.id,
          text: `Rp. ${num_format(v.hargajual)} (${v.tipe_rumah}) ROW${v.row} : Per ${format_date(v.tgl_harga)}`,
          row: v.row,
          tipe: v.tipe_rumah,
          lb: v.lb,
          lt: v.lt,
